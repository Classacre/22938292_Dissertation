...
# INPUT
seurat_path <- "/group/sms029/Oliva_dataset/integrated_col_trajectories_colonly.rds"  # No change needed

# OUTPUTS
output_dir <- "/group/sms029/mnieuwenh/gbm_noise_analysis"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

# Update output filenames to reflect new numbering
expr_matrix_outfile <- file.path(output_dir, "02_expression_matrix.csv")
cell_meta_outfile <- file.path(output_dir, "02_seurat_metadata_full.csv")
